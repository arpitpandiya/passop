        ...
        <div className="flex flex-col p-4 text-black gap-8 items-center">
          ...
          <div className="flex w-full justify-between gap-8">
            ...
            <input
              ...
              className="rounded-full border border-green-500 w-full px-4 py-1 text-black" type="text" name="password" id=""/>
              <span className="absolute right-[3px] top-[4px]  cursor-pointer" onClick={showPassword}>
              <img ref={ref} className="p-1 w-7 h-6 mt-1 mr-0 pt-0"  src="icons/eye.png" alt="eye"/>
              </span>
              </div>
          </div>
